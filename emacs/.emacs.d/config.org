...
#+TITLE: Yash's emacs config
#+AUTHOR: Yashwanth
#+DESCRIPTION: YASH's personal Emacs config.
...
(use-package dashboard
  ...
  ;; Dashboard mode - hide modeline (nuclear option needed, doom re-applies modeline after hook)
